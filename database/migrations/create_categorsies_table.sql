...
CREATE TABLE IF NOT EXISTS categories (
    id CHAR(36) PRIMARY KEY,              -- UUID for the category
    name VARCHAR(255) NOT NULL,             -- Name of the category
    parent CHAR(36),                       -- UUID of the parent category (nullable)
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,   -- Timestamp when the category is created
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP  -- Timestamp when the category is updated
...
INSERT INTO `categories` (`id`, `name`, `parent`) VALUES
    ...
    ('3d4e5f6a-7b8c-9d0e-1f2a-3b4c5d6e7f82', 'Hardware Engineering 2', '2c3d4e5f-6a7b-8c9d-0e1f-2a3b4c5d6e7f'),
